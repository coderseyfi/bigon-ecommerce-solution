...
{
    public partial class ProcuctCatalog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCatalog", x => new { x.ProductId, x.ProductSizeId, x.ProductTypeId, x.ProductMaterialId, x.ProductColorId });
                    table.ForeignKey(
